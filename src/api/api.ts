...
const api = axios.create({
  baseURL: "https://backend-learning-system.onrender.com/api", // always use deployed backend
  headers: {
    "Content-Type": "application/json",
    Authorization: `Bearer ${import.meta.env.VITE_API_KEY}`, // still use the API key from env
  },
});
